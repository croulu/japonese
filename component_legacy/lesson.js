...
function displayButtonReload(oneLesson, oneGuess) {
    ...
    btnReload.addEventListener('click', funcNameReload = function () {
        oneLesson.launchCurrentLesson(oneGuess)
    })
}
...
function displayButtonForward(oneLesson, oneGuess) {
    ...
    btnForward.addEventListener('click', funcNameForward = function () {
        oneLesson.launchNextLesson(oneGuess)
    })
}
